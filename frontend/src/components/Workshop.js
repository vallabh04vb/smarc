...
const Workshop = () => {
  const [isWorkshopExpanded, setIsWorkshopExpanded] = useState(
    Array(workshopsData.length).fill(false)
  );
    ...
    <div className='mt-20'>
      ...
      <div className='p-4'>
        ...
        <p className='mb-6'>
          ...
          you'll receive hands-on training from experienced faculty. From
          mastering critical procedures to exploring advanced medical
          techniques, this conference is your opportunity to build confidence
        ...
        <ul className='list-disc ml-6 mb-6'>
          ...
          <li>
            Expert Guidance: Personalized instruction from seasoned
            professionals and academic leaders.
          </li>
          <li>
            Networking Opportunities: Connect with peers and mentors who share
            your passion for medicine.
          </li>
          <li>
            Certificates of Participation: Earn certificates that recognize your
            commitment to advancing your medical education.
          </li>
          <li>
            Insights into Clinical Practice: Gain a deeper understanding of the
            day-to-day realities and challenges in various medical specialties.
          </li>
          <li>
            APMC Credit Hours: Earn valuable APMC credit hours for your
            participation, ensuring that your learning is recognized and
